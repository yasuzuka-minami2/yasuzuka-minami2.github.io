  ...
  const newsItems = [
    {
      ...
      content: (
        <>
          <Link href="/kairanban/10" className="text-primary hover:underline font-bold block mb-2">
            回覧板第10号はこちらからご覧いただけます
          </Link>
          <Link href="/koho/9" className="text-primary hover:underline font-bold block">
            広報第九回はこちらからご覧いただけます
          </Link>
        </>
      ),
    ...
    {
      id: 7,
      title: "回覧板第9号・広報第八回を更新。",
      date: "2026年5月5日",
      content: (
        <>
          <Link href="/kairanban/9" className="text-primary hover:underline font-bold block mb-2">
            回覧板第9号はこちらからご覧いただけます
          </Link>
          <Link href="/koho/8" className="text-primary hover:underline font-bold block">
            広報第八回はこちらからご覧いただけます
          </Link>
        </>
      ),
    ...
    },
    {
      ...
      content: (
        <>
          <Link href="/kairanban/8" className="text-primary hover:underline font-bold block mb-2">
            回覧板第8号はこちらからご覧いただけます
          </Link>
        </>
      ),
      important: false,
    ...
    {
      id: 5,
      title: "回覧板第7号・広報第七回を更新。",
      date: "2026年4月1日",
      content: (
        <>
          <Link href="/kairanban/7" className="text-primary hover:underline font-bold block mb-2">
            回覧板第7号はこちらからご覧いただけます
          </Link>
          <Link href="/koho/7" className="text-primary hover:underline font-bold block">
            広報第七回はこちらからご覧いただけます
          </Link>
        </>
      ),
    ...
    {
      id: 4,
      title: "回覧板第6号・広報第六回を更新。",
      date: "2026年3月15日",
      content: (
        <>
          <Link href="/kairanban/6" className="text-primary hover:underline font-bold block mb-2">
            回覧板第6号はこちらからご覧いただけます
          </Link>
          <Link href="/koho/6" className="text-primary hover:underline font-bold block">
            広報第六回はこちらからご覧いただけます
          </Link>
        </>
      ),
